...
// (1) Controllers
const { getAllTours, createNewTour, getTourById, updateTour, deleteTour, aliasTour, getTourStats, getMonthlyPlan, getToursWithin, getDistances, uploadTourImages, resizeTourImages } = require('./../controllers/tourController')
...
router.route('/:id')
    ...
    .patch(protect, restrictTo('admin', 'lead-guide'),
        uploadTourImages, //*204
        resizeTourImages,//*204
        updateTour
    )
    .delete(protect, restrictTo('admin', 'lead-guide'), deleteTour) //! GET BY ID
