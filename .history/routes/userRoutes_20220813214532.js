...
const { getAllUsers, createUser, getUser, updateUser, deleteUser, updateMe, deleteMe, getMe, uploadUserPhoto } = require('./../controllers/userController')
...
router.patch('/updateMe', uploadUserPhoto, updateMe); //*[uploadUserPhoto] lect 200
