...
//* NOTE: this part here is not authentication but it's to updating user profile
exports.updatePassword = catchAsync(async (req, res, next) => {
    ...
    user.password = req.body.password;
    user.passwordConfirm = req.body.passwordConfirm;
    await user.save(); //this is the best practiced than using update when working with authentication 
